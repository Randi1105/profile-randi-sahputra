        ...
        <div class="main-container">
            ...
            <div class="app-container">
                ...
                <div class="app-hero-header mb-4">
                    ...
                    <h3 class="fw-bolder text-white my-3"><?= $dataPage['page'] ?> <?= $dataKriteria['nama_kriteria'] ?>
                        (<?= $kode ?>)</h3>
                </div>
                <!-- Panel -->
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label">Nilai Sub Kriteria</label>
                                            <input type="number" class="form-control" name="nilai_sub"
                                                value="<?= $data['nilai_sub'] ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
