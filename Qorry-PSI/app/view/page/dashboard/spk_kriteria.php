                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="?p=Sub&Kode=<?= $row['kode_kriteria'] ?>"
                                                            class="btn btn-primary">(<?= mysqli_num_rows($queryCekSub) ?>)
                                                            Sub Kriteria</a>
                                                        <?php else : ?>
                                                        <button type="button" disabled class="btn btn-primary">Sub
                                                            Kriteria</button>
                                                        <?php endif ?>
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="kode_kriteria"
                                                value="<?= $data['kode_kriteria'] ?>" readonly>
                                        </div>
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label">Nama Kriteria</label>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <select name="jenis_kriteria" class="form-control" required>
                                                ...
                                                <option value="Benefit"
                                                    <?= $data['jenis_kriteria'] == "Benefit" ? 'selected' : '' ?>>
                                                    Benefit</option>
                                                <option value="Cost"
                                                    <?= $data['jenis_kriteria'] == "Cost" ? 'selected' : '' ?>>Cost
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <select name="tipe_kriteria" class="form-control" required>
                                                <option value="" disabled selected>Pilih</option>
                                                <option value="Inputan"
                                                    <?= $data['tipe_kriteria'] == "Inputan" ? 'selected' : '' ?>>Inputan
                                                </option>
                                                <option value="Pilihan"
                                                    <?= $data['tipe_kriteria'] == "Pilihan" ? 'selected' : '' ?>>Pilihan
                                                </option>
                                            </select>
                                        </div>
                                    </div>
