                    ...
                    <div class="d-flex align-items-center mb-4">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                ...
                                <a href="" class="text-decoration-none"><?= $dataPage['panel'] ?></a>
                            </li>
                                            ...
                                            <tbody>
                                                <?php foreach ($queryPengguna as $row) : ?>
                                                    <tr>
                                                        <td><?= $no++ ?></td>
                                                        <td>
                                                            <img src="assets/imgs/pengguna/<?= $row['foto_pengguna'] ?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <select name="jabatan" class="form-control" required>
                                                    <option value="" disabled selected>Pilih</option>
                                                    <option value="Admin"
                                                        <?= $data['jabatan'] == "Admin" ? 'selected' : '' ?>>Admin</option>
                                                    <option value="Pimpinan" <?= $data['jabatan'] == "Pimpinan" ? 'selected' : '' ?>>
                                                        Pimpinan</option>
                                                </select>
                                            </div>
                                            <div class="col-md-12 mb-3">
