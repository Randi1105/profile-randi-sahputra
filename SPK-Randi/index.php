...
$subnilai  = mysqli_num_rows(mysqli_query($con, "SELECT * FROM penilaian"));
        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="text-primary fw-bolder">Selamat Datang <?= $_SESSION['admin']->nama ?> &#128075
                            </h5>
                            <p class="mb-4 fw-bolder text-reset">
                                Sistem Pengambilan Keputusan Penilaian Kinerja Karawan JNE Express Padang Cabang Nipah
                                Menggunakan
                                Metode SMART
                            </p>
                        </div>
